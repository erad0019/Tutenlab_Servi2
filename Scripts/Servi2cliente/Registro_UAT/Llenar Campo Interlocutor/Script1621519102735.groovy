...
WebUI.verifyEqual(WebUI.getText(findTestObject('Var_registro_UTA/Page_TutenServi2Web/Labels/label_interlocutor_I')), label_Interlocutor_I)
...
WebUI.verifyElementPresent(findTestObject('Var_registro_UTA/Page_TutenServi2Web/Alerts/alert_input_Interlocutor_Failed'), 0)

WebUI.click(findTestObject('Var_registro_UTA/Page_TutenServi2Web/Inputs/input_interlocutor'))

WebUI.setText(findTestObject('Var_registro_UTA/Page_TutenServi2Web/Inputs/input_Insert_Interlocutor_Number'), insert_Interlocutor)
