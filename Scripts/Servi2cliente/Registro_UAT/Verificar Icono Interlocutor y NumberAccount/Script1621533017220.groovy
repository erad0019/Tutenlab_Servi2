...
WebUI.verifyElementPresent(findTestObject('Var_registro_UTA/Page_TutenServi2Web/Icons/icon_Help_Outline_Interlocutor'), 0)
...
WebUI.verifyElementPresent(findTestObject('Var_registro_UTA/Page_TutenServi2Web/Icons/icon_Help_Outline_NumberAccount'), 0)

WebUI.click(findTestObject('Var_registro_UTA/Page_TutenServi2Web/Icons/icon_Help_Outline_NumberAccount'))
