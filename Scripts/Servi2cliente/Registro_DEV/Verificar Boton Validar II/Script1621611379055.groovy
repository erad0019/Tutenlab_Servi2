...
WebUI.setText(findTestObject('Object Repository/Var_registro_DEV/Page_TutenServi2Web/input_Insert_Interlocutor'), Interlocutor_I)

WebUI.setText(findTestObject('Object Repository/Var_registro_DEV/Page_TutenServi2Web/input_Insert_NumberAccount'), NumberAccount_I)
